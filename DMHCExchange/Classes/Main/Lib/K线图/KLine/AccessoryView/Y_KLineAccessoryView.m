...
- (void)drawRect:(CGRect)rect {
    ...
    if(self.targetLineStatus != Y_StockChartTargetLineStatusKDJ){
        ...
        [self.needDrawKLineAccessoryPositionModels
         enumerateObjectsUsingBlock:^(Y_KLineVolumePositionModel * _Nonnull volumePositionModel, NSUInteger idx, BOOL * _Nonnull stop) {
