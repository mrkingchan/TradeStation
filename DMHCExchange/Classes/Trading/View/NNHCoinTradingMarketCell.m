...
@interface NNHCoinTradingMarketCell ()
...
@implementation NNHCoinTradingMarketCell
...
- (void)setCoinTradingMarketModel:(NNCoinTradingMarketModel *)coinTradingMarketModel
{
    _coinTradingMarketModel = coinTradingMarketModel;
    
    self.coinNameLabel.text = coinTradingMarketModel.coinname;
    self.ccyLabel.text = [NSString stringWithFormat:@"/%@",coinTradingMarketModel.unitcoinname];
    self.coinUSDPriceLabel.text = coinTradingMarketModel.close_price;
    self.maxPriceLabel.text = coinTradingMarketModel.max_price;
    self.minPriceLabel.text = coinTradingMarketModel.min_price;
    self.volumeLabel.text = coinTradingMarketModel.volume;
    self.percentageLabel.text = coinTradingMarketModel.changestr;
    
    if ([coinTradingMarketModel.change containsString:@"-"]) { // 下跌
...
- (UILabel *)maxPriceLabel
{
    if (_maxPriceLabel == nil) {
        _maxPriceLabel = [UILabel NNHWithTitle:@"0.00" titleColor:[UIConfigManager colorTextLightGray] font:[UIConfigManager fontThemeTextTip]];
...
- (UILabel *)minPriceLabel
{
    if (_minPriceLabel == nil) {
        _minPriceLabel = [UILabel NNHWithTitle:@"0.00" titleColor:[UIConfigManager colorTextLightGray] font:[UIConfigManager fontThemeTextTip]];
...
{
    if (_volumeLabel == nil) {
        _volumeLabel = [UILabel NNHWithTitle:@"0.00" titleColor:[UIConfigManager colorTextLightGray] font:[UIConfigManager fontThemeTextTip]];
